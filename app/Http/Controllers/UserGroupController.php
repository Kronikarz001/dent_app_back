...
use App\Http\Requests\AssignUserGroupUsersRequest;
...
class UserGroupController extends Controller
{
    ...
    /**
     * @param UserGroup $userGroup
     * @param AssignUserGroupUsersRequest $request
     * @return JsonResponse
     */
    #[OA\Patch(
        path: '/api/user-group/{uuid}/users',
        summary: 'Przypisuje użytkowników do grupy, zastępując poprzednią listę',
        security: [['sanctum' => []]],
        requestBody: new OA\RequestBody(
            required: true,
            content: new OA\JsonContent(
    ...
    public function assignUsers(UserGroup $userGroup, AssignUserGroupUsersRequest $request): JsonResponse
    {
